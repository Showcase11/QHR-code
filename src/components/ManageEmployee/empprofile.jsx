...
const Empprofile = () => {
  ...
  return (
    <Layout>
      <div class="container grid grid-cols-4 h-[1008px] bg-zinc-100 pt-5">
        <div class="col-span-5 md:col-span-1 bg-base-100 shadow mr-5">
        <div className="p-5">
            <img
              src={Img1}
              alt="profile"
            ...
            <h2 className="pb-5 text-gray-400">HR Manager</h2>
            <hr className="pb-5" />
            <div className="flex">
            ...
            <div className="modal">
              <div className="modal-box  w-11/12 max-w-3xl">
                ...
                <h1 className="font-bold text-2xl pb-3">Offboard Employee</h1>
                <hr className="pb-5" />
                <div className="flex items-center px-2 py-3">
                  <form className="w-full">
                    ...
                    <div className="md:flex md:items-center mb-6">
                      ...
                      <div className="w-3/4">
                        <select className="select text-gray-500 w-full border-inherit">
                          ...
                          <option>
                            Sukanya <p>sukanya@grovehr.com</p>
                          </option>
                          <option>
                            Sahithya <p>Sahithya@grovehr.com</p>
                          </option>
                          <option>
                            Arth <p>Arth@grovehr.com</p>
                          </option>
                          <option>
                            Ibrahim <p>Ibrahim@grovehr.com</p>
                          </option>
                          <option>
                            Rahul <p>Rahul@grovehr.com</p>
                          </option>
                          <option>
                            Shourya <p>Shourya@grovehr.com</p>
                          </option>
                        </select>
                      </div>
                    </div>
                    <div className="md:flex md:items-center mb-6">
                      ...
                      <div className="w-3/4">
                        <textarea
                          className="h-36 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                          id="inline-full-name"
                          type="text"
                          placeholder="Note"
                        />
                ...
                <p className="flex">
                  <IoInformationCircleOutline className="text-xl text-green-400 mr-2" />
                  Notes
                </p>
                <ul className="list-disc pl-6">
                  <li>
                    This employee’s account will be deactivated automatically
                    after the last working date.
                  </li>
                  <li>
                    Offboarding will delete all tasks, progress, information and
                    files of an IN PROGRESS onboarding checklist (if any).
                  </li>
                </ul>
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  <div className="rounded-md shadow">
                    <button
                      value="Submit"
                      className="flex w-full items-center justify-center rounded-md border border-transparent bg-green-400 px-3 py-2  font-bold text-white hover:bg-green-500  md:px-5 text-sm"
                    >
                      Offboard
                    </button>
                  </div>
                  <div className="mt-3 sm:mt-0 sm:ml-3">
                    <button className="flex w-full items-center justify-center rounded-md border border-transparent bg-slate-300 px-3 py-2  font-bold text-slate-600 hover:bg-slate-400 md:px-5 text-lg">
                      Cancel
                    </button>
                  </div>
                </div>
            ...
            <div className="modal">
              <div className="modal-box  w-11/12 max-w-3xl">
                ...
                <h2 className="font-bold text-lg pb-3">Assign Checklist</h2>
                <hr className="pb-5" />

                <div className="flow-root pb-7 gap-3">
                  <p className="float-left w-2/5">
                    <h3 className="flex pb-5">
                    ...
                    <select
                      className="select text-gray-500 w-full border-inherit"
                  ...
                  <p className="float-right w-2/5">
                    <h3 className="pb-5 flex">
                      <IoInformationCircleOutline className="text-xl text-zinc-400 mr-2" />
                      Join Date: 07 Oct 2022
                    </h3>
                ...
                <p className="flex">
                  <IoInformationCircleOutline className="text-xl text-zinc-400 mr-2" />
                  We will send reminders to employee about incomplete tasks.
                </p>
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  <div className="rounded-md shadow">
                    <button
        ...
        <div class="col-span-5 md:col-span-3 h-[1008px]">
      ...
      {/* <div className="flex p-12 bg-zinc-100">
        <div className="col-span-5 md:col-span-1 p-2 h-[1008px] bg-base-100 border">
          <div className="p-7">
            <img
              src={Img1}
              alt="profile"
        ...
        <div className="col-span-5 md:col-span-3 h-96 p-2 w-full">
          <div className="grid grid-cols-1 gap-6 mb-6 lg:grid-cols-1">
