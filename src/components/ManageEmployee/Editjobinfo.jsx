...
const Editjobinfo = () => {
    return (
        <div>
            <input type="checkbox" id="editjobinfo" className="modal-toggle" />
<div className="modal">
  <div className="modal-box w-11/12 max-w-3xl">
    <label htmlFor="editjobinfo" className="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
    <h2 className="font-bold text-lg pb-3">Edit Job Information</h2><hr className='pb-5' />
