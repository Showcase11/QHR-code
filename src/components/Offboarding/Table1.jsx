                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <IoIosRadioButtonOff className='text-2xl cursor-pointer'/>
                                    </td>
                                    ...
                                    <label htmlFor="edittableoff" className="modal-button"><RiPencilLine className='text-2xl p-0.5 mr-3 cursor-pointer'/></label>
<input type="checkbox" id="edittableoff" className="modal-toggle" />
<div className="modal">
  <div className="modal-box w-11/12 max-w-3xl">
    <label htmlFor="edittableoff" className="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
...
<a href="#deletetableoff"><BiTrashAlt className='text-2xl text-red-400 p-0.5 mr-3 cursor-pointer'/></a>
<div className="modal" id="deletetableoff">
            ...
            <div className="mt-3 sm:mt-0 sm:ml-3">
              <button id="my-modal-5" className="flex w-full items-center justify-center rounded-md border border-transparent bg-slate-300 px-3 py-2 text-base font-bold text-slate-600 hover:bg-slate-400 md:px-5 text-lg"> <a href="#">Cancel</a></button>
                                ...
                                <tr className=''>
                                    ...
                                    {/* <td className="flex px-6 py-4 text-sm font-medium text-right whitespace-nowrap">Onboarding for 
                                       <img
                                         src={Img1}
                                         alt="profile"
