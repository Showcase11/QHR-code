...
const Changepswd = () => {
  const { password, user, setPassword } = useGlobalContext();
    ...
    <Layout>
     ...
     <div className=" flex items-center justify-center h-screen">
        <div className="relative items-stretch flex w-[60%] border-[1px] border-gray-200 shadow-lg bg-white justify-center overflow-hidden">
          ...
          <div className="w-full flex-1 p-6 bg-gradient-to-r from-indigo-200 to-indigo-50 px-8  lg:max-w-xl">
      ...
      <form onSubmit={handleSubmit(onFormSubmit)} className="mt-8">
          <div className="my-5 w-full">
            ...
            <input
              ...
              className={`block w-full px-4 py-2 mt-2 bg-white border rounded-md focus:outline-none focus:ring focus:ring-opacity-40 ${errors.password ? 'border-red-500' : 'border-borderClr'}`}
            />
          ...
          <label
            ...
            <input
              ...
              className={`block w-full px-4 py-2 mt-2 bg-white border rounded-md focus:outline-none focus:ring focus:ring-opacity-40 ${
                errors.confirmPassword ? 'border-red-500' : 'border-borderClr'
              }`}
            />
