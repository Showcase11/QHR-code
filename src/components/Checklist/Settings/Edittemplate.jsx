...
const Edittemplate = () => {
    ...
    return (
        <div>
            <div className="modal" id="cardedit">
  <div className="modal-box w-11/12 max-w-3xl">
    <label htmlFor="cardedit" className="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
    <h2 className="font-bold text-lg pb-3">Edit Template</h2><hr className='pb-5' />
